...
#Ticommunication Ticommunication_MAX_INSTANCES 2
#Ticommunication Ticommunication_MAX_BACKENDS 2
#Ticommunication ENGINE_MAX_CYLINDERS 1

#include <AP_Common/AP_Common.h>
#include <AP_HAL/AP_HAL.h>

// Time in milliseconds before we declare the Ticommunication to be "unhealthy"
#dTicommunicationne HEALTHY_LAST_RECEIVED 3000
